...
{
	Peripheral_write_Function_t writes;			/* The function used to write to the peripheral. */
 ...
 */
#define FreeRTOS_write( xPeripheral, pvBuffer, xBytes ) ( ( Peripheral_Control_t * ) xPeripheral )->writes( ( ( Peripheral_Control_t * ) xPeripheral ), ( pvBuffer ), ( xBytes ) )
